...
import com.tjmolinski.bloom.util.ImageCache.ImageCacheParams;
import com.tjmolinski.bloom.util.ImageFetcher;
 ...
 */
public class BloomGridFragment extends Fragment implements
	...
	private int selectedBloom = -1;

	/**
	 * Empty constructor as per the Fragment documentation
	 */
	public BloomGridFragment() {
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mBloom = (Bloom) this.getArguments().getParcelable("BLOOM");
		mAdapter = new ImageAdapter(getActivity(), mBloom);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View v = inflater.inflate(R.layout.bloom_grid_fragment,
				container, false);
	...
	public boolean onItemLongClick(AdapterView<?> parent, View v, int position, long id) {
		selectedBloom = position - mAdapter.getNumColumns();
		...
		.setPositiveButton("Yes", new OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				Runnable run = new Runnable() {
					@Override
					public void run() {
						File pic = mBloom.getPicture(selectedBloom);
						pic.delete();
						mAdapter.notifyDataSetChanged();
					}
				};
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public ImageAdapter(Context context, Bloom bloom) {
			super();
			mContext = context;
			mBloom = bloom;
		...
		public int getCount() {
			...
			return mBloom.getImageCount() + mNumColumns;
		}

		@Override
		public Object getItem(int position) {
			return position < mNumColumns ? null : mBloom.getPicture(position
					- mNumColumns);
		}
		...
		public View getView(int position, View convertView, ViewGroup container) {
			...
			mImageFetcher.loadImage(mBloom.getPicture(position - mNumColumns),
					imageView);
